@extends('umslayout')
@section('titlename') Examination Entry @endsection
            ...
            <div class="col-lg-6">
				<ol class="breadcrumb float-right">
                    ...
                    <li class="breadcrumb-item active">
                        <strong>Examination Entry</strong>
                    </li>
                </ol>
            </div>
        </div>
						...
						<div class="ibox-content">
							<div class="table-responsive">
								<table id="tableMain" class="table table-striped table-bordered display table-hover" >
									<thead>
										<tr>
											<th style="display:none;">Examination Id</th>
											<th>Serial</th>
											<th>Examination</th>
											<th>Action</th>
										</tr>
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form role="form" id="addeditform">
                            	{{ csrf_field() }}
                                <div class="form-group row"><label class="col-lg-2 col-form-label">Examination<span class="fontred">*</span></label>
                                    <div class="col-lg-5">
										<input type="text" id="ExamName" name="ExamName" placeholder="Enter Examination" class="form-control" required>
                                    </div>
                                </div>
...
<script>
	...
	function onConfirmWhenDelete(recordId) {
		...
		$.ajax({
			"type" : "POST",
			"url": SITEURL+"/deleteExaminationRoute",
			datatype:"json",
            data: {
            	"id":recordId,
	...
	function onConfirmWhenAddEdit() {
	    ...
	    $.ajax({
	        type: "post",
	        url: SITEURL+"/addEditExaminationRoute",
    ...
    $(document).ready(function() {
		...
		$( ".examination-menu" ).addClass( "active" );
		...
		tableMain = $("#tableMain").dataTable({
		    ...
		    "iDisplayLength" : 10,
		    "ajax":{
		        "url": "<?php route('examinationListTblMain') ?>",
		        "datatype": "json",
		        "type": "post",
		    ...
		    "fnDrawCallback" : function(oSettings) {
		            ...
		            $('a.itmEdit', tableMain.fnGetNodes()).each(function() {
		                ...
		                $(this).click(function() {
		                    ...
		                    resetForm("addeditform");
                            $('#recordId').val(aData['ExamId']);
		                    $('#ExamName').val(aData['ExamName']);
				...
				$('a.itmDrop', tableMain.fnGetNodes()).each(function() {
					...
					$(this).click(function() {
						...
						swal({
							...
							onConfirmWhenDelete(aData['ExamId']);
						});
					});
				});
