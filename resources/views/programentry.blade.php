@extends('umslayout')
@section('titlename') Program Entry @endsection
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form role="form" id="addeditform">
                            	{{ csrf_field() }}
                                <div class="form-group row"><label class="col-lg-2 col-form-label">Program<span class="fontred">*</span></label>
                                    <div class="col-lg-5">
										<input type="text" id="Program" name="Program" placeholder="Enter Program" class="form-control" required>
                                    </div>
                                </div>
...
<script>
	...
	function onConfirmWhenDelete(recordId) {
		...
		$.ajax({
			"type" : "POST",
			"url": SITEURL+"/deleteProgramRoute",
			datatype:"json",
            data: {
            	"id":recordId,
	...
	function onConfirmWhenAddEdit() {
	    ...
	    $.ajax({
	        ...
	        url: SITEURL+"/addEditProgramRoute",
    ...
    $(document).ready(function() {
		...
		tableMain = $("#tableMain").dataTable({
		    ...
		    "iDisplayLength" : 10,
		    "ajax":{
		        "url": "<?php route('programListTblMain') ?>",
		        "datatype": "json",
		        "type": "post",
				...
				$('a.itmDrop', tableMain.fnGetNodes()).each(function() {
					...
					$(this).click(function() {
						...
						swal({
							...
							onConfirmWhenDelete(aData['ProgramId']);
						});
					});
				});
		    ...
		    "columns":[
		        ...
		        {"data":"Program","sWidth": "78%"},
		        {"data":"action","sWidth": "12%", "sClass": "dt-center", "bSortable": false}
		    ]
		});
