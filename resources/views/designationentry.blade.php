@extends('umslayout')
@section('titlename') Designation Entry @endsection
            ...
            <div class="col-lg-6">
				<ol class="breadcrumb float-right">
                    ...
                    <li class="breadcrumb-item active">
                        <strong>Designation Entry</strong>
                    </li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form role="form" id="addeditform">
                            	{{ csrf_field() }}
                                <div class="form-group row"><label class="col-lg-2 col-form-label">Designation<span class="fontred">*</span></label>
                                    <div class="col-lg-5">
										<input type="text" id="Designation" name="Designation" placeholder="Enter Designation" class="form-control" required>
                                    </div>
                                </div>
...
<script>
	...
	function onConfirmWhenDelete(recordId) {
		...
		$.ajax({
			"type" : "POST",
			"url": SITEURL+"/deleteDesignationRoute",
			datatype:"json",
            data: {
            	"id":recordId,
	...
	function onConfirmWhenAddEdit() {
	    ...
	    $.ajax({
	        type: "post",
	        url: SITEURL+"/addEditDesignationRoute",
    ...
    $(document).ready(function() {
		...
		$( ".designation-menu" ).addClass( "active" );
		...
		tableMain = $("#tableMain").dataTable({
		    ...
		    "iDisplayLength" : 10,
		    "ajax":{
		        "url": "<?php route('designationListTblMain') ?>",
		        "datatype": "json",
		        "type": "post",
		    ...
		    "fnDrawCallback" : function(oSettings) {
		            ...
		            $('a.itmEdit', tableMain.fnGetNodes()).each(function() {
		                ...
		                $(this).click(function() {
		                    ...
		                    resetForm("addeditform");
                            $('#recordId').val(aData['DesignationId']);
		                    $('#Designation').val(aData['Designation']);
				...
				$('a.itmDrop', tableMain.fnGetNodes()).each(function() {
					...
					$(this).click(function() {
						...
						swal({
							...
							onConfirmWhenDelete(aData['DesignationId']);
						});
					});
				});
