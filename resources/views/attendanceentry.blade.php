@extends('umslayout')
@section('titlename') Attendance Entry @endsection
						...
						<div class="ibox ">
							<div class="ibox-title">
								...
								<div class="ibox-tools">
									<a class="" href="javascript:void(0);" id="btnAdd"><span class="label label-info"><i class="fa fa-plus"></i>&nbsp;New Attendance</span></a>
								</div>
							</div>
							<div class="ibox-content">
								<div class="table-responsive">
									<table id="tableMain" class="table table-striped table-bordered display table-hover" >
										<thead>
											<tr>
												<th style="display:none;">AttId</th>
												<th>Serial</th>
												<th>Date</th>
												<th>Subject</th>
												<th>Absence</th>
                            ...
                            <form role="form" id="addeditform">
								...
								<div class="form-group row" id="daterangecontrol">
									...
									<div class="col-lg-2 daterangecontrol">
										<div class="input-daterange input-group">
											<input type="text" class="form-control-sm form-control" name="AttDate" id="AttDate" data-date-format="dd/mm/yyyy" required />
										</div>
									</div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col align-self-center">
										...
										<a href="javascript:void(0)" class="btn btn-primary btn-sm" id="btnSubmit"><i class="fa fa-save"></i> Start Attendance</a>
						...
						<div class="ibox-content">
							...
							<div class="table-responsive">
								<table id="tableItems" class="table table-striped table-bordered display table-hover" >
									<thead>
										<tr>
											<th style="display:none;">AttItemId</th>
											<th>Serial</th>
											<th>Student Code</th>
											<th>Student Name</th>
											<th>Batch</th>
...
<script>
	...
	function onConfirmWhenDelete(recordId) {
		...
		$.ajax({
			"type" : "POST",
			"url": SITEURL+"/deleteAttendanceRoute",
			datatype:"json",
            data: {
            	"id":recordId,
	...
	function onConfirmWhenAddEdit() {
	    ...
	    $.ajax({
	        type: "post",
	        url: SITEURL+"/addAttendanceMasterItemsRoute",
...
function getSubjectList() {
    ...
    function getTableMainData(){
		...
		tableMain = $("#tableMain").dataTable({
		    ...
		    "iDisplayLength" : 10,
		    "ajax":{
		        "url": "<?php route('attendanceListTblMain') ?>",
		        "datatype": "json",
		        "type": "post",
		        "data": {
		        	"YearId":$("#fYearId").val(),
				...
				$('a.itmDrop', tableMain.fnGetNodes()).each(function() {
					...
					$(this).click(function() {
						...
						swal({
							...
							onConfirmWhenDelete(aData['AttId']);
						});
					});
				});
		    ...
		    "columns":[
		        {"data":"AttId","bVisible" : false},
		        {"data":"Serial","sWidth": "6%", "sClass": "dt-center", "bSortable": false},
		        {"data":"AttDate","sWidth": "15%"},
		        {"data":"SubjectName","sWidth": "41%"},
		        ...
		        {"data":"action","sWidth": "13%", "sClass": "dt-center", "bSortable": false},
    ...
    function getItemData(){
		...
		tableItems = $("#tableItems").dataTable({
					...
					"iDisplayLength" : 25,
				    "ajax":{
				        url: SITEURL+"/attendanceentryItemRoute",
				        "datatype": "json",
				        "type": "post",
				        "data": {
				        	"AttId":$("#recordId").val(),
				    ...
				    "fnDrawCallback" : function(oSettings) {
				            ...
				            $('input.attChange', tableItems.fnGetNodes()).each(function() {
								$(this).click(function() {
									var nTr = this.parentNode.parentNode;
									var aData = tableItems.fnGetData(nTr);
									recordId = aData['AttItemId'];
									//console.log(aData);
				    ...
				    "columns":[
				        {"data":"AttItemId","bVisible" : false},
				        {"data":"Serial","sWidth": "6%", "sClass": "dt-center", "bSortable": false},
				        {"data":"StudentCode","sWidth": "15%"},
				        {"data":"StudentName","sWidth": "41%"},
				        {"data":"Batch","sWidth": "10%","sClass": "dt-right"},
				        {"data":"Absence","sWidth": "10%","sClass": "dt-right"},
				        {"data":"Present","sWidth": "10%","sClass": "dt-right"},
				        {"data":"AttId","bVisible" : false},
