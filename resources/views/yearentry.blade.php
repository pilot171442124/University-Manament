						...
						<div class="ibox-content">
							<div class="table-responsive">
								<table id="tableMain" class="table table-striped table-bordered display table-hover" >
									<thead>
										<tr>
											<th style="display:none;">Year Id</th>
											<th>Serial</th>
											<th>Year</th>
											<th>Action</th>
										</tr>
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form role="form" id="addeditform">
                            	{{ csrf_field() }}
                                <div class="form-group row"><label class="col-lg-2 col-form-label">Year<span class="fontred">*</span></label>
                                    <div class="col-lg-5">
										<input type="text" id="Year" name="Year" placeholder="Enter Year" class="form-control" required>
                                    </div>
                                </div>
				...
				$('a.itmDrop', tableMain.fnGetNodes()).each(function() {
					...
					$(this).click(function() {
						...
						swal({
							...
							onConfirmWhenDelete(aData['YearId']);
						});
					});
				});
